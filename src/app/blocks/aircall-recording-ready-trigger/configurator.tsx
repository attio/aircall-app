...
import {recordingOutcomeSchema, voicemailOutcomeSchema} from "./lib/outcome-schema"
    ...
    return (
        <>
            <ComboboxInput
                ...
                options={options}
            />
            <Outcome id="recording" label="Recording ready" schema={recordingOutcomeSchema} />
            <Outcome id="voicemail" label="Voicemail ready" schema={voicemailOutcomeSchema} />
        </>
    )
})
